...
BVH tree can be constructed based on three different splitting criteria. There are three popular strategies to split the tree node:
...
\begin{figure}[H]	
     ...
     \begin{subfigure}[b]{0.475\textwidth}
         ...
         \includegraphics[width=5cm]{images/example_lbvh/morton.png}
